...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-D0p3pSsw.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-zWDjd8gm.js");
		return {
			get "ErrorBoundary"() {
	...
	"cdcea89e5e0d": async () => {
		const m = await import("./assets/LearningWorkspace-GuRH2aQ3.js");
		return { get "default"() {
			return m["default"];
		} };
	}
...
//#endregion
export { __exportAll as a, app_ssr_entry_default as default, handleSsr, __commonJSMin as i, usePathname as n, __toESM as o, useRouter as r, getLayoutSegmentContext as t };
